      ...
      <div className="about">
        ...
        <div className="article">
          ...
          <div className="article-about">
            <p className="py-2">「遊戲大亂鬥」網站創立於 2012 年，主要致力於推廣台灣電子競技以及實況影片、直播之電競社群。</p>
            <p className="py-2">成立的初衷是常常在 YouTube
            上可以發現國外玩家行之有年的將自己的遊戲電競影片剪輯後上傳分享的風氣，在台灣還不見普及。為了推廣讓網友除了看遊戲實況，也可以將自己有趣的影片上傳分享，開始了我們精心挑選引進外國影片分享給網友，最終想要推動華人地區的玩家們人人皆分享電競實況影片的風氣。也讓更多玩家可以不只玩遊戲也可以從中獲得成就感。</p>
            <p className="py-2">至今，遊戲大亂鬥目前是台灣最新最紅的遊戲實況影片網站，每月有 120萬+ 個活躍使用者，在
            alexa Taiwan
            排名大約在 100 名左右，遊戲的社群網路之中年輕人最喜愛的電競遊戲影片社群，同時也是最多網友投稿遊戲實況影片互動的網絡。</p>
          </div>
          ...
          <div className="text-center mt-20">
            ...
            <div className="flex justify-center mt-12">
              <Link href={"https://www.facebook.com/GameSmash/"} >
                <Image className="mx-3" src="/about/about_icon1.png" alt="fb" width={30} height={30} /> 
              </Link>
              <Link href={"https://www.youtube.com/channel/UCd4vjuRpRn8Ibd3OcPZHsuw"} >
                <Image className="mx-3" src="/about/about_icon2.png" alt="yt" width={30} height={30} /> 
              </Link>
              <Link href={"https://www.facebook.com/messages/GameSmash"} >
                <Image className="mx-3" src="/about/about_icon3.png" alt="email" width={30} height={30} />  
              </Link>
              <Link href={"https://www.league-funny.com/advertise"} >
                <Image className="mx-3" src="/about/about_icon4.png" alt="ad" width={30} height={30} /> 
              </Link>
            </div>
          </div>
        </div>
